...
// if threshold > inuse * 2, so gcPercent > 100, and GC negatively to avoid GC too frequently
...
// TuningWithAuto By automatic calculation of the total amount of memory
